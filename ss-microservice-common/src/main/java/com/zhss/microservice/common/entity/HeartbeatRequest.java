...
public class HeartbeatRequest extends Request {
    ...
    public static class Builder {
        ...
        public HeartbeatRequest.Builder serviceName(String serviceName) {
            this.request.setServiceName(serviceName);
            return this;
        }

        public HeartbeatRequest.Builder serviceInstanceIp(String serviceInstanceIp) {
            this.request.setServiceInstanceIp(serviceInstanceIp);
            return this;
        }

        public HeartbeatRequest.Builder serviceInstancePort(Integer serviceInstancePort) {
     ...
     * @return
     */
    public static HeartbeatRequest deserialize(ByteBuffer buffer) {
        // 解析请求id
